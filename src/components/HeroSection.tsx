  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        ...
        <h1 style={revealStyle(isVisible, 100)} className="font-serif text-4xl md:text-6xl lg:text-7xl font-medium leading-tight mb-8">
          Confiança esculpida{" "}
          <span className="gradient-gold-text italic">nos detalhes.</span>
        </h1>

        <p style={revealStyle(isVisible, 200)} className="text-muted-foreground text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-4">
          Nem sempre é sobre mudar o rosto. É sobre se sentir bem com você.
        </p>
        <p style={revealStyle(isVisible, 300)} className="text-muted-foreground text-base md:text-lg leading-relaxed max-w-2xl mx-auto mb-10">
        ...
        <div style={revealStyle(isVisible, 450)} className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
        ...
        {/* Scroll indicator */}
        <div
          style={revealStyle(isVisible, 600)}
