  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        <h1 style={revealStyle(isVisible, 0)} className="font-serif text-4xl md:text-6xl lg:text-7xl font-medium leading-tight mb-8">
          Confiança esculpida{" "}
          <span className="text-gold italic">nos detalhes.</span>
        </h1>

        <p style={revealStyle(isVisible, 150)} className="text-muted-foreground text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-4">
        ...
        <div style={revealStyle(isVisible, 450)}>
          <a
